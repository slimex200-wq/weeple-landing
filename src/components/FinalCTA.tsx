...
export default function FinalCTA() {
  return (
    <section
      id="final-cta"
      className="relative min-h-[90vh] flex items-center justify-center py-32 px-6 overflow-hidden bg-gradient-to-br from-[#F97066] via-[#D4533F] to-[#818cf8]"
      aria-label="앱 다운로드"
    >
      <div className="max-w-5xl w-full text-center">
        ...
        >
          <MagneticButton
            as="a"
            href="#"
            className="group inline-flex items-center gap-2 px-7 h-14 rounded-full bg-white text-[#D4533F] font-semibold text-base transition-all hover:scale-[1.02] hover:shadow-[0_12px_40px_-8px_rgba(0,0,0,0.3)] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#D4533F]"
          >
